...
public class Library {
    public Library(String name, String address, Book[] books, Libreriant libreriant) {
        this.name = name;
        this.address = address;
        this.books = books;
        this.libreriant = libreriant;
    }
    ...
    public Libreriant getLibreriant() {
        return libreriant;
    }

    public void setLibreriant(Libreriant libreriant) {
        this.libreriant = libreriant;
    }
